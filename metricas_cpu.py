...
for modelo_seleccionado in modelos_yolo:
    ...
    print(f"Modelo {modelo_seleccionado} movido a {DEVICE.upper()}.")
    # -----------------------------------------
    ...
    with open(output_file_path, "w", encoding='utf-8') as out_f:
        ...
        for video_path in video_files:
            ...
            resultados = model(video_path_str, 
                            ...
                            verbose=False, 
                            save=True, 
                            project= resultado_dir / modelo_seleccionado, # Use Path object for project dir
                            exist_ok=True, 
                            device=DEVICE)
            frame_idx = 0
            ...
            print("LA RE PUTA") # Nueva línea después del progreso del video
